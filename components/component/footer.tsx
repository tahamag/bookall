      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4 lg:gap-16">
          <div className="flex items-center justify-center lg:justify-start">
            <Image src="/placeholder.svg?height=60&width=200" alt="TravelApp Logo" width={200} height={60} />
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-base text-gray-300 mb-4">Get the latest news and articles sent to your inbox weekly.</p>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          ...
          <div className="mt-8 md:mt-0 md:order-1">
            <p className="text-base text-gray-400">
                &copy; 2024 BookAll, Inc. All rights reserved. Made by MTM
            </p>
          </div>
        </div>
      </div>
